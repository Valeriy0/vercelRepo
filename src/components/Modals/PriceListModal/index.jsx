...
export const PriceListModal = ({ openedModal, handleCloseModal, nextLvl, activeLvls }) => {
  return (
    <Modal isOpened={openedModal} onClose={handleCloseModal}>
      <div className="flex p-8 flex-col  items-start justify-start w-[918px] rounded-3xl space-y-11 sm:w-full sm:rounded-none sm:rounded-t-3xl sm:px-4 sm:h-[650px] sm:p-0 sm:pt-10 sm:space-y-6 ">
