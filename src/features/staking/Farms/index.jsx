...
export const Farms = () => {
    ...
    return (
        <div className="flex flex-col h-[700px] space-y-9">
            ...
            <div className="flex space-x-6 sm:flex-col sm:space-x-0 sm:space-y-6">
                ...
                <button className="flex justify-center items-center rounded-3xl farms-bg min-h-[222px] min-w-[261px] sm:min-w-full border-[1px] border-white-100 backdrop-blur-large">
