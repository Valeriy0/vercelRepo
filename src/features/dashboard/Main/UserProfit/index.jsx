...
export const UserProfit = () => {
  return (
    <div className="flex user-profit-bg flex-col relative justify-between bg-lightGray h-[268px] w-full row-span-1 col-span-2 rounded-3xl p-8 border-[1px] border-white-100 sm:p-0 sm:px-[19px] sm:pt-6 sm:pb-[26px] poppins z-[1] sm:h-full shadow-item backdrop-blur-large">
